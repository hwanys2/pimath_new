...
export default function StudentTopBar({ actor }: { actor: StudentActor }) {
  ...
  return (
    <header className="px-3 pt-3 sm:px-4 sm:pt-4">
      <nav className="wood-bar mx-auto flex max-w-6xl items-center gap-2 rounded-2xl px-2.5 py-2 sm:gap-4 sm:px-5 sm:py-3">
        <Link
          href="/adventure"
          aria-label="나의 모험"
        ...
        <div className="flex min-w-0 flex-1 items-center justify-center">
          <Link
            href="/adventure"
            className={`font-display max-w-full truncate rounded-xl px-2 py-2 text-sm transition sm:px-5 sm:text-base ${
              onAdventure
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          <Link
            href="/adventure"
            className={`flex items-center gap-1 rounded-xl px-1.5 py-1.5 transition sm:gap-1.5 sm:px-2 ${
              onAdventure
          ...
          >
            ...
            />
            <span className="font-display whitespace-nowrap text-sm">
              Lv.{actor.level}
            </span>
          </Link>
