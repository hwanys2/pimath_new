...
const CONTENT_KEY = "g3-u3-1-sincos-intro";

export const metadata: Metadata = {
  title: "사인·코사인 탐구 | 수학하는 즐거움",
  description:
    "연실·사다리·거치대의 빗변과 각만으로 수평거리와 높이를 구하고, 표를 만들며 사인·코사인을 만나는 중3 탐구 활동. 학생은 선생님이 수업을 시작할 때만 참여하고, 비로그인·교사는 직접 조작해 볼 수 있어요.",
};

export default async function SincosIntroPage({
  searchParams,
}: {
